...
const Navbar = () => {
  ...
  return (
    <nav
      className={`${styles.paddingX} w-full flex items-center py-5 fixed top-0 absolute left-0 z-20 bg-primary`}
    >
      <div className='w-full flex justify-between items-center max-w-7xl mx-auto '>
        ...
        <div className=' flex sm:hidden flex-1 justify-end items-center '>
          ...
          <div
            className={`${
              !toggle ? "hidden" : "flex"
            }  violet-gradient absolute top-20 right-0 w-4/5 -translate-x-11 pb-2.5 px-5 transition z-10 rounded-xl`}
          >
